            ...
            <div class="column is-4">
                ...
                <div class="field">
                    ...
                    <template v-if="$v.username.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.username.maxLength">Must be at least 5 characters long</p>
                        <p class="help is-danger" v-if="!$v.username.minLength">Must be no more than 20 characters</p>
                        <p class="help is-danger" v-if="!$v.username.complex">Invalid format</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <template v-if="$v.password.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.password.minLength">Must be no more than 8 characters</p>
                        <p class="help is-danger" v-if="!$v.password.complexPassword">Password must contain at least one
                            uppercase letter, one lowercase letter, and one number</p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <template v-if="$v.first_name.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.first_name.complex">Invalid format for first name</p>
                        <p class="help is-danger" v-if="!$v.first_name.maxLength">First name cannot exceed 150 characters
                        </p>
                    </template>
                </div>
                ...
                <div class="field">
                    ...
                    <template v-if="$v.last_name.$error">
                        ...
                        <p class="help is-danger" v-if="!$v.last_name.complex">Invalid format for last name</p>
                        <p class="help is-danger" v-if="!$v.last_name.maxLength">Last name cannot exceed 150 characters</p>
                    </template>
                </div>
